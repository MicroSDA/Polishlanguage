        ...
        <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="thumbnail">
                            <div class="caption">
                                ...
                                <p>
                                    Фамилия: <?= DataManager::getInstance()->getDataByKey('Teacher')->getLASTNAME() ?></p>
            ...
            <div class="col-md-3">
                <div class="jumbotron" style="text-align: center;">
                    ...
                    <img src="<?= DataManager::getInstance()->getDataByKey('Teacher')->getPHOTO() ?>" class="img-thumbnail" style="">
                    <input type="text" id="name" value="<?= DataManager::getInstance()->getDataByKey('Teacher')->getID() ?>" hidden>
                    <br>
                    <br>
                ...
                <div class="jumbotron" style="text-align: center;">
                    <div id="change-password">
                        <form id="change-password-form" onsubmit="return false" autocomplete="off">
                            <input type="text" name="id" value="<?= DataManager::getInstance()->getDataByKey('Teacher')->getID() ?>" hidden>
